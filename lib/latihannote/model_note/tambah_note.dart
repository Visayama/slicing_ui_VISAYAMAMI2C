...
import 'package:slicing_ui_visayamami2c/latihannote/latihannote.dart';
import 'package:slicing_ui_visayamami2c/latihannote/model_note/ModelAdd.dart';
import 'package:slicing_ui_visayamami2c/latihannote/model_note/model_note.dart'; // Import halaman PageUtama
  ...
  Future<ModelAddNotes?> addNotes() async {
    ...
    try {
      ...
      http.Response response = await http.post(
        Uri.parse('http://192.168.100.100/latihannote/addNote.php'),
        body: {
          "judul": txtJudul.text,
          "isi": txtIsi.text,
        },
      ...
      if (data.value == 1) {
        ...
        setState(() {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PageNote()),
          );
        });
